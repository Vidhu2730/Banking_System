...
if(isset($_POST["transfer"]) && isset($_POST["toAccountNumber"]) && isset($_POST["amount"]) && isset($_POST["myaccount"])){
    ...
    if($amount <0){
        ...
        echo "<script> alert('You cannot transfer to self') ; window.location = '../allCustomers.php' </script>";
        ...
        echo "<script> alert('Transaction Successful') ; window.location = '../allCustomers.php' </script>";
    }
